...
export type PartnersAgencyProps = {
  title: string;
  logos: LogoProps[];
};
    ...
    logos: [
      {
        alt: "Google",
        imageUrl:
          "https://yanmazsunger.net/wp-content/uploads/2021/09/5c7120fa2d05cec571969c2d_google-logo-export-v1.png",
      },
      {
        alt: "Amazon",
        imageUrl:
          "https://yanmazsunger.net/wp-content/uploads/2021/09/5c71210dc6a0652e7a79e8ac_amazon-logo-export-v1.png",
      },
      {
        alt: "Toptal",
        imageUrl:
          "https://yanmazsunger.net/wp-content/uploads/2021/09/5c71212e6e5e68afc3eab981_toptal-logo-export-v1.png",
      },
      {
        alt: "InVision",
        imageUrl:
          "https://yanmazsunger.net/wp-content/uploads/2021/09/5c7121203f8bb20f5623ca81_invision-logo-export-v1.png",
      },
    ],
  },
  render: ({ title, logos }: PartnersAgencyProps) => {
    return (
      <>
        <div className="w-full flex flex-col justify-center items-center relative overflow-hidden bg-neutral-900">
          <svg
          ...
          <div className="container flex flex-col justify-center items-center relative py-16 gap-8 text-white">
