...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#3182ce" fill="none">
  <path d="M5 8V5c0-1 1-2 2-2h10c1 0 2 1 2 2v3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  <path d="M19 16v3c0 1-1 2-2 2H7c-1 0-2-1-2-2v-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  <line x1="4" x2="20" y1="12" y2="12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
</svg>
  ),
  fields: {
    color: {
