...
const SiteMap: React.FC<SiteMapProps> = ({ site, templates }) => {
  ...
  const organizePages = useCallback((flatPages: Page[]): Page[] => {
  ...
  const renderPageNode = useCallback(
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuItem>
                      <Link
                        ...
                        target="_blank"
                        href={`/site/${site.path}/${page.path}/edit`}
                      >
    ...
    [expandedNodes, handleDeletePage, site, templates, toggleNode, fetchPages]
  );
        ...
        <CardContent>
          {memoizedPages.length === 0 ? (
            ...
            <div className="space-y-4">
              {memoizedPages.map((page) => renderPageNode(page))}
            </div>
          )}
        </CardContent>
      </Card>
